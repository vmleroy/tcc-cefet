...
generator.load_state_dict(torch.load('src/data/mario/results/db-gamegan_nz-32_tiles-13_ngf-64_ndf-64_wgan-dagstuhl_v-1/pths/netG_epoch_77500_0_32.pth', map_location=lambda storage, loc: storage))
